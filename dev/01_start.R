...
##
golem::fill_desc(
  pkg_name = "MHScreener", # The Name of the package containing the App
  pkg_title = "MHScreener", # The Title of the package containing the App
  pkg_description = "Project ACCESS Mental Health Screener App.", # The Description of the package containing the App
